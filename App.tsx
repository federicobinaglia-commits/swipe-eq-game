...
const generateLevel = (difficulty: number): Term[] => {
  ...
  // If difficulty >= 1.2 (approx score >= 20, or after 2 equations), allow non-1 coefficients
  let finalCoeff = 1;
  if (difficulty >= 1.2) {
...
export default function App() {
  ...
  // Difficulty increases by 0.2 every 2 solved equations
